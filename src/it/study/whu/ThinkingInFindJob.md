...
#小结与建议#
  ...
  1. 在个人复习时从基础出发，我这里主要是谈谈技术开发。语言关自然不多说，C系自然需要融会贯通于指针、链表、虚类等语言构件；然后就是把语言很好运用起来的数据结构与算法: [ItStudyWhuDatastructureslinks 数据结构相关知识]
...
#相关材料#
  1. [笔试面试题汇总](FindJob)
  1. [数据结构代码](../../technical/algorithm/DataStructures)
  1. [设计模式相关](../../technical/design/DesignPattern)
