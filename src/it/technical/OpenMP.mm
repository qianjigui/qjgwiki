...
<node CREATED="1311442322924" ID="ID_830233061" MODIFIED="1311451471612">
<richcontent TYPE="NODE">&lt;html&gt;
  &lt;body&gt;
    &lt;p&gt;
      &lt;code language=&quot;c&quot;&gt;sum = 0; #pragma omp parallel shared(n,a,sum) private(TID, sumLocal) { 
          TID = omp_get_thread_num();     sumLocal = 0;     #pragma omp for 
               for(int i=0;i&lt;n sumlocal=&quot;#DEFAULT&quot; i=&quot;#DEFAULT&quot;&gt;    #pragma omp critical (update_sum) 
              {               sum += sumLocal;               printf(&amp;quot;TID=%d: 
      sumLocal=%d sum = %d \n&amp;quot;, TID, sumLocal, sum);         } } &lt;/code&gt;
    &lt;/p&gt;
  &lt;/body&gt;
&lt;/html&gt;
</richcontent>
